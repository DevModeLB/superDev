...
public class SQLiteConnector implements DatabaseConn {
    ...
    private void createTables(Statement stmt) throws SQLException {
        String[] tableCreationQueries = {
                ...
                "CREATE TABLE IF NOT EXISTS customer (id INTEGER PRIMARY KEY AUTOINCREMENT, name TEXT NOT NULL, email TEXT NOT NULL, phone TEXT, address TEXT, synced INTEGER DEFAULT 0, deleted INTEGER DEFAULT 0);",
                ...
                "CREATE TABLE IF NOT EXISTS orderitem (id INTEGER PRIMARY KEY AUTOINCREMENT, quantity INTEGER NOT NULL, subtotal DECIMAL(10,2) NOT NULL, orderID INTEGER, productID INTEGER, synced INTEGER DEFAULT 0, deleted INTEGER DEFAULT 0, FOREIGN KEY (orderID) REFERENCES 'order'(id), FOREIGN KEY (productID) REFERENCES product(id));",
